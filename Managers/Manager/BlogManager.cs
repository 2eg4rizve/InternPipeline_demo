...
namespace InternPipeline.Managers.Manager
{
    public class BlogManager : IBlogManager
    {
        ...
        public async Task<CommonResponse> CreateBlog(CreateBlogRequestEntity createBlogRequestEntity)
        {
            ...
            try
            {
                ...
                var createTopic = await _blogRepository.CreateBlog(new BlogModel
                {
